...
CREATE TABLE `aw_accounts`  (
  ...
  `avatar` varchar(1500) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT 'http://localhost:8890/upload/20210612/16234847490027294.png',
...
-- ----------------------------
INSERT INTO `aw_accounts` VALUES (1, 'admin', '$2b$10$lHM2cWr9x.kcHIbe9aDgTeaU10RuKaoud8Zowm07OyIXJhL6N0bvu', '2021-04-13 22:06:24', '2021-06-12 18:18:47', 1, 'http://localhost:8890/upload/20210612/16234846156416317.png', '超级管理员', '张三', '男', '技术一部', '浙江-杭州');
...
INSERT INTO `aw_accounts` VALUES (16, 'editor', '$2b$10$BmRzMNTLMocyHqzHNutBQuZJJ6j/S0mkdgK/Ffe7E/jiVovFh9ezi', '2021-06-04 21:32:15', '2021-06-15 09:40:16', 2, 'http://localhost:8890/upload/2021064/16228135311306915.jpg', '文章编辑员', '李四', '男', '运营一部', '北京');
INSERT INTO `aw_accounts` VALUES (27, 'normal', '$2b$10$yF/EfQIgxM5QErwfOjOX6OL.GH6fTO5yIFbvnzEszbk.FKMHQxWVu', '2021-06-15 22:00:19', '2021-06-15 22:00:19', 3, 'http://localhost:8890/upload/20210615/16237656051412474.png', '普通用户', NULL, NULL, NULL, NULL);
INSERT INTO `aw_accounts` VALUES (28, 'normal02', '$2b$10$eOw05lZiBVUF/IOP8cZeYOV4gYcba.1FkNMv1EaC2l20EX0XOq1YO', '2021-06-15 22:00:47', '2021-06-15 22:00:47', 3, 'http://localhost:8890/upload/20210615/16237656414616152.png', '普通用户', NULL, NULL, NULL, NULL);
...
-- ----------------------------
INSERT INTO `aw_products` VALUES (1, 'http://localhost:8890/upload/20210521/keleji01.png', 'http://localhost:8890/upload/20210521/keleji.png', 'keleji', '可记', '可记是一个极简风格设计的笔记产品', '适合笔记记录与散文写作,它附带了一个功能丰富的扩展键盘和一些精美的主题,既可以作为纯文本编辑器使用又可以保存富媒体样式的笔记', 'http://localhost:8080', '2021-04-15 19:54:34', '2021-04-15 19:54:36');
INSERT INTO `aw_products` VALUES (2, 'http://localhost:8890/upload/20210521/secai01.png', 'http://localhost:8890/upload/20210521/secai.png', 'secai', '色彩', '这是一款写给大家用的配色 APP', '无论你是配色初学者,还是专业设计师都能通过应用内提供的多种配色方式,寻找配色灵感,轻松搭配出好色彩', 'http://localhost:8080', '2021-04-15 19:56:53', '2021-04-15 19:56:55');
INSERT INTO `aw_products` VALUES (3, 'http://localhost:8890/upload/20210521/tell01.png', 'http://localhost:8890/upload/20210521/tell.png', 'tell', 'Tell', 'Tell 是一个通过倾诉来消解的平台。', '我们希望每个用户在 Tell 写下或者说出故事之后,能够得到「有效」的回应。这些回应可能不是正确的,但是你总能找到一些微小的支点,支撑起你已经混沌的内心', 'http://localhost:8080', '2021-04-15 19:58:29', '2021-04-15 19:58:35');
INSERT INTO `aw_products` VALUES (4, 'http://localhost:8890/upload/20210521/keleji01.png', 'http://localhost:8890/upload/20210521/keleji.png', 'keleji', '可记', '可记是一个极简风格设计的笔记产品', '适合笔记记录与散文写作,它附带了一个功能丰富的扩展键盘和一些精美的主题,既可以作为纯文本编辑器使用又可以保存富媒体样式的笔记', 'http://localhost:8080', '2021-04-15 20:00:36', '2021-04-15 20:00:39');
INSERT INTO `aw_products` VALUES (5, 'http://localhost:8890/upload/20210616/16238199734679283.jpg', 'http://localhost:8890/upload/20210616/16238199812926337.png', NULL, '后台管理系统', '后台管理系统', '后台管理系统12', 'http://localhost:9000', '2021-06-16 13:06:24', '2021-06-16 13:06:24');
